...
±±ºPrograma  ³ANALISE   ºAutor  ³B4B                 º Data ³  19/08/2012 º±±
...
@ 045,190 MSGET oVar   VAR cCrlEnd   Picture "@!"       SIZE 015,10 PIXEL OF oDlgMain When lPermi VALID(MudaLocaliz())
...
@ 220,002 SAY "B4B " 						 SIZE 200,10 PIXEL OF oFolder:aDialogs[1] FONT oBold  COLOR CLR_HBLUE
@ 220,435 SAY "Versão 2.0"                   SIZE 200,10 PIXEL OF oFolder:aDialogs[1] FONT oBold  COLOR CLR_HBLUE
...
cCrlEnd  := If(SB1->B1_LOCALIZ="S","SIM","NAO")
...
Endif
        ...
        SB1->B1_LOCALIZ := IIF(cCrlEnd ="SIM","S","N")
